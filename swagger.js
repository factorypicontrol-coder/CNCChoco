      ...
      schemas: {
        ...
        Config: {
          ...
          properties: {
            ...
            template_font: { type: 'string', enum: ['hershey', 'block', 'script', 'pristina', 'calibri', 'logo'], description: 'Template font', example: 'hershey' },
            ...
            message_font: { type: 'string', enum: ['hershey', 'block', 'script', 'pristina', 'calibri', 'logo'], description: 'Message font', example: 'hershey' },
        ...
        UpdateConfigRequest: {
          ...
          properties: {
            template_text: { type: 'string', description: 'Template text to engrave', example: 'KPMG' },
            template_font: { type: 'string', enum: ['hershey', 'block', 'script', 'pristina', 'calibri', 'logo'], description: 'Template font' },
            ...
            message_font: { type: 'string', enum: ['hershey', 'block', 'script', 'pristina', 'calibri', 'logo'], description: 'Message font' },
